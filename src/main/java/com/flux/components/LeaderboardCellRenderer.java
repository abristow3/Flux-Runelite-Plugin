...
public class LeaderboardCellRenderer extends DefaultTableCellRenderer {
	...
	private final AnimatedShinyBorder goldBorder = new AnimatedShinyBorder(new Color(212, 175, 55),
		3);
	private final AnimatedShinyBorder silverBorder = new AnimatedShinyBorder(
		new Color(192, 192, 192), 3);
	private final AnimatedShinyBorder bronzeBorder = new AnimatedShinyBorder(
		new Color(205, 127, 50), 3);
